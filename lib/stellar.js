...
class StellarHandler {
  ...
  mergeAccount = async (account, accountSecret, sponsor, sponsorSecret, destination) => {
    ...
    const bumpedTx = sdk.TransactionBuilder.buildFeeBumpTransaction(sponsor, sdk.BASE_FEE, sdk.TransactionBuilder.fromXDR(xdr, this.networkPassphrase), this.networkPassphrase)
